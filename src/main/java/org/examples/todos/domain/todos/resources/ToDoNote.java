...
public class ToDoNote extends DomainEntity<UUID, ToDoNoteBaseInfo, ToDoNoteInfo, ToDoNote> {
    
    public ToDoNote(ToDoNoteBaseInfo baseInfo) 
    {
		super(baseInfo);
	}
    
    public ToDoNote(ToDoNoteInfo fullInfo)
    {
    	super(fullInfo);
    }
